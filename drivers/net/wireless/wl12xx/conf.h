...
enum {
#if 0
	/* LiorC: Add  below to fw first, then fix this rate enum */
	CONF_HW_RXTX_RATE_MCS7_SGI = ??,
#endif
	CONF_HW_RXTX_RATE_MCS15 = 0,
	CONF_HW_RXTX_RATE_MCS14,
	CONF_HW_RXTX_RATE_MCS13,
	CONF_HW_RXTX_RATE_MCS12,
	CONF_HW_RXTX_RATE_MCS11,
	CONF_HW_RXTX_RATE_MCS10,
	CONF_HW_RXTX_RATE_MCS9,
	CONF_HW_RXTX_RATE_MCS8,
...
/* ToDo: LiorC - it is only a WA till fw implements this rate, to be changed later on  */
#define CONF_HW_RXTX_RATE_MCS7_SGI CONF_HW_RXTX_RATE_MCS7
...
#define CONF_TX_RATE_MASK_SISO_40_MHZ 	  (CONF_TX_MCS_RATES | CONF_TX_AP_ENABLED_RATES | BIT(31))

#define CONF_TX_RATE_MASK_MIMO_20MHZ 	      (CONF_TX_MCS_RATES_MIMO | CONF_TX_AP_ENABLED_RATES)
#define CONF_TX_RATE_MASK_MIMO_40MHZ 	      (CONF_TX_MCS_RATES_MIMO | CONF_TX_AP_ENABLED_RATES | BIT(31))
...
#define CONF_TX_MCS_RATES_MIMO (CONF_TX_MCS_RATES | CONF_HW_BIT_RATE_MCS_8 |      \
