...
static inline u32 wlcore_raw_read_reg(struct wl1271 *wl, int reg)
{
	return wl1271_raw_read32(wl, wl->rtable[reg]);
}

static inline void wlcore_raw_write_reg(struct wl1271 *wl, int reg, u32 val)
{
	wl1271_raw_write32(wl, wl->rtable[reg], val);
}
