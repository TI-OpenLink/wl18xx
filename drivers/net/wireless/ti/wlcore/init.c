...
static int wl1271_sta_hw_init(struct wl1271 *wl, struct wl12xx_vif *wlvif)
{
	...
	/*
	 * TODO: there was an ext_radio_params call here for wl127x.
	 * Moved it to wl12xx as part of the main init (not only for
	 * sta HW).  Need to test if non-STA roles still work with
	 * this change in wl127x.
	 */
