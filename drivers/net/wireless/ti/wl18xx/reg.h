...
#define WL18XX_WELP_ARM_COMMAND		(WL18XX_REGISTERS_BASE + 0x007100)

#define WL18XX_CHIP_ID_B               (WL18XX_REGISTERS_BASE + 0x01542C)

#define WL18XX_RXTX_ENABLE		(WL18XX_REGISTERS_BASE + 0x01543C)
...
#define WL18XX_PHY_INIT_MEM	   0x80926000

/* to be written to WL18XX_SCR_PAD2 */
#define BOARD_TYPE_FPGA		0xB1
#define BOARD_TYPE_HDK		0xB2
#define BOARD_TYPE_DVP_EVB	0xB3

/* to be written to WL18XX_WELP_ARM_COMMAND */
