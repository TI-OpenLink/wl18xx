				  ...
				  const u8 *bssid, bool reconfig)
{
	...
	case NL80211_CHAN_HT40PLUS:
		if (sdata->vif.bss_conf.channel->flags & IEEE80211_CHAN_NO_HT40PLUS)
			disable_40 = true;
		break;
	case NL80211_CHAN_HT40MINUS:
		if (sdata->vif.bss_conf.channel->flags & IEEE80211_CHAN_NO_HT40MINUS)
			disable_40 = true;
		break;
	default:
		break;
				     ...
				     u8 *wmm_param, size_t wmm_param_len)
{
	...
	sdata->wmm_admitted = (~(sdata->wmm_acm)) & 0xFF ;
